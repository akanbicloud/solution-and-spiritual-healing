...
export function WhatsAppGroupBanner() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto my-10 px-4">
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-deep via-emerald-forest to-emerald-dark text-white p-6 sm:p-10 shadow-soft-lg border border-gold/40">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="w-full md:w-auto shrink-0">
            <a
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-2xl bg-gradient-to-r from-gold to-gold-light text-charcoal font-bold text-sm sm:text-base shadow-soft hover:shadow-soft-lg hover:scale-[1.02] active:scale-[0.98] transition-all"
            >
