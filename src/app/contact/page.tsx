...
export default function ContactPage() {
  ...
  const contactSchema = {
    ...
    name: "Contact Alfacairo & Visit Alfa Cairo House",
    description:
      "Contact information and location directions for Alfa Cairo House in Owode Egba, Ogun State, Nigeria.",
    mainEntity: {
  ...
  return (
    <>
      ...
      <div className="w-full flex flex-col py-8 sm:py-16">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12 sm:mb-16">
          <div className="bg-cream rounded-3xl border border-gold-hairline/70 p-6 sm:p-10">
            <div className="max-w-3xl mb-8">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white border border-gold-hairline text-emerald-deep text-xs font-bold uppercase tracking-wider mb-3">
                Transit Directions
              </div>
              <h2 className="text-2xl sm:text-3xl font-bold font-serif text-charcoal">
                How to Reach Alfa Cairo House in Owode Egba
              </h2>
              <p className="mt-2 text-xs sm:text-sm text-muted leading-relaxed">
                Owode Egba is strategically located in Ogun State, easily accessible via major highways from Lagos, Abeokuta, Sagamu, and Ibadan.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
              <div className="bg-white rounded-2xl p-5 border border-gold-hairline/80 shadow-soft-sm">
                <div className="flex items-center gap-2.5 mb-2.5 text-emerald-deep font-bold font-serif text-base">
                  <Car size={20} weight="fill" />
                  <h3>Coming from Lagos (Berger / Ikeja)</h3>
                </div>
                <p className="text-xs sm:text-sm text-muted leading-relaxed">
                  Take the Lagos-Ibadan Expressway up to the Sagamu Interchange. Exit onto the Sagamu-Abeokuta Expressway heading toward Abeokuta. Continue until you arrive at Owode Egba junction. Ask for or navigate directly to “Alfa Cairo House” (prominent green two-storey building).
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-5 border border-gold-hairline/80 shadow-soft-sm">
                <div className="flex items-center gap-2.5 mb-2.5 text-emerald-deep font-bold font-serif text-base">
                  ...
                  <h3>Coming from Abeokuta</h3>
                </div>
                <p className="text-xs sm:text-sm text-muted leading-relaxed">
                  Take the Abeokuta-Sagamu Road heading toward Owode Egba / Sagamu Interchange. The journey is approximately 25 to 35 minutes depending on traffic. Alfa Cairo House is located within Owode Egba township with landmark access.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-5 border border-gold-hairline/80 shadow-soft-sm">
                <div className="flex items-center gap-2.5 mb-2.5 text-emerald-deep font-bold font-serif text-base">
                  <Car size={20} weight="fill" />
                  <h3>Coming from Sagamu</h3>
                </div>
                <p className="text-xs sm:text-sm text-muted leading-relaxed">
                  Head toward the Sagamu-Abeokuta Expressway. Drive past the interchange toward Abeokuta. Owode Egba is reached in approximately 15 to 20 minutes.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-5 border border-gold-hairline/80 shadow-soft-sm">
                <div className="flex items-center gap-2.5 mb-2.5 text-emerald-deep font-bold font-serif text-base">
                  <Compass size={20} weight="fill" />
                  <h3>Coming from Ibadan</h3>
                </div>
                <p className="text-xs sm:text-sm text-muted leading-relaxed">
                  Take the Ibadan-Lagos Expressway down to the Sagamu Interchange, then loop onto the expressway heading toward Abeokuta. Owode Egba is the primary central hub along this route.
                </p>
              </div>
            </div>
          </div>
