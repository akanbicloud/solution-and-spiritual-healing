  ...
  return (
    <div className="w-full flex flex-col py-12 sm:py-16">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-6 space-y-6">
            {/* Phone Card */}
            <div className="p-6 rounded-3xl bg-white border border-gold-hairline shadow-soft flex items-start gap-4">
              <div className="p-3 rounded-2xl bg-emerald-light text-emerald-deep shrink-0">
              ...
              <div className="flex-1">
                ...
                <div className="mt-3">
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-emerald-600 text-white text-xs font-bold shadow-soft hover:bg-emerald-500 transition-all"
                  >
            ...
            {/* Social Media Links */}
            <div className="p-6 rounded-3xl bg-cream-light border border-gold-hairline/60">
              ...
              <div className="flex flex-wrap items-center gap-3">
                {siteConfig.socials.facebook ? (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-white border border-gold-hairline text-xs font-bold text-charcoal hover:text-emerald-deep transition-colors shadow-soft-sm"
                  >
          ...
          <div className="lg:col-span-6 space-y-4">
            <div className="relative aspect-[4/3] w-full rounded-3xl overflow-hidden shadow-soft-lg border-2 border-gold/40">
              ...
              />
              <div className="absolute bottom-4 inset-x-4 p-4 rounded-2xl bg-white/95 backdrop-blur-md border border-gold-hairline text-xs sm:text-sm">
                <div className="font-bold font-serif text-charcoal">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <div className="bg-white rounded-3xl border border-gold-hairline/80 p-6 sm:p-8 shadow-soft-lg">
          <div className="flex flex-col sm:flex-row items-center justify-between mb-6 gap-4">
            <div className="flex items-center gap-3">
              <div className="p-2.5 rounded-xl bg-emerald-light text-emerald-deep">
                <MapPin size={24} weight="fill" />
              </div>
              <div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-emerald-deep hover:bg-emerald-forest text-white font-bold text-xs sm:text-sm shadow-soft transition-all shrink-0"
            >
          ...
          <div className="relative w-full h-[450px] sm:h-[520px] rounded-2xl overflow-hidden border border-gold-hairline">
            <iframe
