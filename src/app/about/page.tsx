      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="p-6 sm:p-8 rounded-3xl bg-white border border-gold-hairline shadow-soft space-y-4">
            ...
            {settings.credentials && settings.credentials.length > 0 && (
              <div className="p-6 rounded-3xl bg-white border border-gold-hairline shadow-soft-sm">
                ...
                <ul className="space-y-2 text-xs sm:text-sm text-charcoal">
                  {settings.credentials.map((cred, idx) => (
                    <li key={idx} className="flex items-center gap-2">
                      <ShieldCheck size={16} weight="fill" className="text-emerald-deep" />
                      <span>{cred}</span>
                    </li>
                  ))}
                </ul>
            ...
            <div className="pt-2 flex flex-wrap gap-4">
              <Link
                href="/book"
                className="inline-flex items-center gap-2 px-7 py-3.5 rounded-2xl bg-emerald-deep hover:bg-emerald-forest text-white font-bold text-xs sm:text-sm shadow-soft transition-all hover-lift"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-7 py-3.5 rounded-2xl bg-white hover:bg-cream border border-gold-hairline text-emerald-deep font-bold text-xs sm:text-sm shadow-soft-sm transition-all hover-lift"
              >
